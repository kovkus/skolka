...
<ul class="tmpl-variables">
        <li><span class="variable">{TITLE}</span> &mdash; <?php echo $lang['tmpl_var_post_title'];?> [<span class="simurl toggle450" rel="tmpl-title"><?php echo $lang['tmpl_vars_more_variables'];?></span>]
          <ul id="tmpl-title" class="hide">
            <li><span class="variable">{TITLE_PLAIN}</span> &mdash; <?php echo $lang['tmpl_var_post_title_plain'];?></li>
          </ul>
        </li>
        ...
        <li><span class="variable">{LINK}</span> &mdash; <?php echo $lang['tmpl_var_post_link'];?> [<span class="simurl toggle450" rel="tmpl-links"><?php echo $lang['tmpl_vars_more_variables'];?></span>]
          <ul id="tmpl-links" class="hide">
            <li><span class="variable">{FRIENDLY_URL}</span> &mdash; <?php echo $lang['tmpl_var_post_friendly_url'] . ', ' . $lang['tmpl_vars_example'] . ': <span class="example">' . $lang['tmpl_var_post_friendly_url_example'] . '</span>';?></li>
            <li><span class="variable">[LINK]</span> &amp; <span class="variable" onclick="insert_value('[/LINK]', document.getElementById('tmpl'))">[/LINK]</span> &mdash; <?php echo $lang['tmpl_var_post_link_perm'];?></li>
            <li><span class="variable">[VAR-LINK]</span> &amp; <span class="variable" onclick="insert_value('[/VAR-LINK]', document.getElementById('tmpl'))">[/VAR-LINK]</span> &mdash; <?php echo $lang['tmpl_var_post_link_bb'];?></li>
            <!--<li><span class="variable" onclick="insert_value('[PERM-LINK]', document.getElementById('tmpl'))">[PERM-LINK]</span> &amp; <span class="variable" onclick="insert_value('[/PERM-LINK]', document.getElementById('tmpl'))">[/PERM-LINK]</span> &mdash; <?php echo $lang['tmpl_var_post_link_perm'];?></li>-->
          </ul>
        </li>
        ...
        <li><span class="variable">{COMMENTS}</span> &mdash; <?php echo $lang['tmpl_var_post_comments'] . ', ' . $lang['tmpl_vars_example'] . ': <span class="example">' . $lang['web_comments'] . ' (6)</span>';?> [<span class="simurl toggle450" rel="tmpl-comments"><?php echo $lang['tmpl_vars_more_variables'];?></span>]
          <ul id="tmpl-comments" class="hide">
            <li><span class="variable">{COMMENTS_COUNT}</span> &mdash; <?php echo $lang['tmpl_var_post_comments_count'];?></li>
          </ul>
        </li>
        <li><span class="variable">{VIEWS}</span> &mdash; <?php echo $lang['tmpl_var_post_views'];?></li>
