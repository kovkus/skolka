$(document).ready(function() {
  ...
  $('.toggle').on('click', function() {$('#' + $(this).attr('rel')).slideToggle();});
  $('.toggle450').on('click', function() {$('#' + $(this).attr('rel')).slideToggle(450);});
  $('.toggle750').on('click', function() {$('#' + $(this).attr('rel')).slideToggle(750);});


  $('.tmpl-variables span.variable').on('click', function() {
  ...
  $('#new_tag').keypress(function(e) {
	...
	$('#gallery .gal-item').on('click', function() {
	...
	$('#mn-popup #insert_as').on('change', function() {
	...
	/* --- close popup */
	$('#mn-popup .pop-close').on('click', function() {
